---
name: code-reviewer
description: Use when reviewing pull requests (PRs), providing code quality feedback, or identifying security vulnerabilities in a codebase. Trigger when needing an objective analysis of code changes, ensuring adherence to coding standards, or performing a security sanity check before merging.
license: MIT
---
