---
name: senior-qa
description: Use when designing test strategies, implementing automated test suites, or performing end-to-end (E2E) testing. Trigger when experiencing low test coverage, frequent regressions after release, or needing to establish quality gates for a CI/CD pipeline.
license: MIT
---
