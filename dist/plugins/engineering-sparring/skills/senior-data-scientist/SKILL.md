...
description: Use when designing statistical experiments, building predictive models, or performing causal inference. Trigger when needing to optimize A/B tests, experiencing low model accuracy, or needing to derive actionable business insights from complex datasets.
license: MIT
---
