...
description: Use when developing modern web applications with React and Next.js, optimizing frontend performance, or implementing complex UI designs. Trigger when experiencing large bundle sizes, slow page loads, or needing a consistent component generator for a design system.
license: MIT
---
