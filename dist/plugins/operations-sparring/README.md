...
**A specialized AI Sparring Partner for Operations professionals.**
...
**Operations Sparring** is a **Cognitive System**, not just a script runner.
...
```bash
/plugin install operations-sparring@conversational-sparring-marketplace
```
