...
**A specialized AI Sparring Partner for People & Culture professionals.**
...
**People Sparring** is a **Thinking Partner**. It combines:
...
3.  **Deep Skills**: A library of 6 professional skills (not just distinct scripts, but integrated workflows).
...
```bash
/plugin install people-sparring@conversational-sparring-marketplace
```
