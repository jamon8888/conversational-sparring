...
**A specialized AI Sparring Partner for Personal Development professionals.**
...
**Personal Sparring** is a **Cognitive System**, not just a script runner.
...
```bash
/plugin install personal-sparring@conversational-sparring-marketplace
```
