...
**A specialized AI Sparring Partner for Sales & Revenue professionals.**
...
**Sales Sparring** is a **Cognitive System**, not just a script runner.
...
```bash
/plugin install sales-sparring@conversational-sparring-marketplace
```
