...
description: Use when analyzing social media campaign performance with engagement metrics and ROI calculations. Trigger when needing to calculate engagement rates and ROAS (scripts/calculate_metrics.py), identifying high-performing content types through trend detection, or comparing multi-platform performance against industry benchmarks.
license: MIT
---
