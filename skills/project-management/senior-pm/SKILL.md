---
name: senior-pm
description: Use when planning high-level project roadmaps, managing stakeholder expectations, or identifying project risks. Trigger when a project lacks clear objectives, needing a RACI matrix for cross-functional alignment, or wanting to evaluate the ROI of a new initiative.
license: MIT
---
