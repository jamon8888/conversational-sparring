...
### 1. Brand Voice Analyzer (`skills/marketing/content-creator/scripts/brand_voice_analyzer.py`)
...
python skills/marketing/content-creator/scripts/brand_voice_analyzer.py content.txt json
```
...
### 2. SEO Optimizer (`skills/marketing/content-creator/scripts/seo_optimizer.py`)
...
```bash
# Basic SEO analysis
python skills/marketing/content-creator/scripts/seo_optimizer.py article.md "primary keyword"

# With secondary keywords
python skills/marketing/content-creator/scripts/seo_optimizer.py article.md "primary keyword" "secondary,keywords,here"

# JSON output
python skills/marketing/content-creator/scripts/seo_optimizer.py article.md "keyword" --json
```
...
### 3. Demand Generation Analyzer (`skills/marketing/marketing-demand-acquisition/scripts/`)
...
```bash
python skills/marketing/marketing-demand-acquisition/scripts/demand_gen_analyzer.py campaign-data.csv
```
...
**Location:** `skills/marketing/content-creator/references/`
...
**Location:** `skills/marketing/content-creator/assets/`
