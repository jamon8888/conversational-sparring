...
description: Use when setting up a Microsoft 365 tenant, managing user lifecycles, or configuring security and compliance policies. Trigger when needing to automate bulk user provisioning, hardening tenant security against breaches, or auditing Microsoft 365 usage and licenses.
license: MIT
---
