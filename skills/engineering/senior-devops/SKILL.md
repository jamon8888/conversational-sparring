---
name: senior-devops
description: Use when setting up CI/CD pipelines, automating infrastructure with Terraform, or managing containerized deployments. Trigger when experiencing deployment failures, inconsistent environment configurations, or needing to scale cloud infrastructure across AWS, GCP, or Azure.
license: MIT
---
