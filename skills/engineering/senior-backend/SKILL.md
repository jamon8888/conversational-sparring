---
name: senior-backend
description: Use when building scalable backend systems, optimizing database performance, or implementing secure API architectures. Trigger when experiencing slow query responses, integration bottlenecks, or needing a robust backend scaffolding for a new service.
license: MIT
---
