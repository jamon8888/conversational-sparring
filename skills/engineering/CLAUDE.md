...
### 1. Project Scaffolder (`skills/engineering/senior-fullstack/scripts/project_scaffolder.py`)
...
```bash
# Create new project
python skills/engineering/senior-fullstack/scripts/project_scaffolder.py my-project --type nextjs-graphql

# Start services
cd my-project && docker-compose up -d
```

### 2. Code Quality Analyzer (`skills/engineering/senior-fullstack/scripts/code_quality_analyzer.py`)
...
```bash
# Analyze project
python skills/engineering/senior-fullstack/scripts/code_quality_analyzer.py /path/to/project

# JSON output
python skills/engineering/senior-fullstack/scripts/code_quality_analyzer.py /path/to/project --json
```
...
```bash
# 1. Scaffold project
python skills/engineering/senior-fullstack/scripts/project_scaffolder.py my-app --type nextjs-graphql
...
```bash
# 1. Analyze codebase
python skills/engineering/senior-fullstack/scripts/code_quality_analyzer.py ./
...
python skills/engineering/senior-ml-engineer/scripts/mlops_setup_tool.py

# 2. Deploy model
python skills/engineering/senior-ml-engineer/scripts/model_deployment_pipeline.py model.pkl
