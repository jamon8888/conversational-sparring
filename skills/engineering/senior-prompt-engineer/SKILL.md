...
description: Use when optimizing LLM prompts, designing prompt templates, or building agentic AI systems. Trigger when experiencing "hallucinations", needing structured outputs (JSON/XML), or wanting to reduce token consumption and costs.
license: MIT
---
