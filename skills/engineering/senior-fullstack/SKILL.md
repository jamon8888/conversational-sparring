...
description: Use when building end-to-end web applications, scaffolding new fullstack projects, or performing comprehensive code quality audits. Trigger when starting a new project from scratch, needing a unified tech stack recommendation, or analyzing code quality across the entire stack.
license: MIT
---
