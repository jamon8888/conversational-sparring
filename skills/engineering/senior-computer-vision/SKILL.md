...
description: Use when implementing image/video processing, training custom object detection models, or optimizing vision AI inference. Trigger when experiencing low detection accuracy, needing real-time visual analysis, or building high-performance visual perception systems.
license: MIT
---
