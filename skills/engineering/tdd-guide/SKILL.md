---
name: tdd-guide
description: Use when implementing Test-Driven Development (TDD) workflows, generating test cases from requirements, or analyzing test coverage. Trigger when struggling with "Red-Green-Refactor" cycles, needing to convert manual requirements into automated tests, or identifying untested edge cases in a module.
license: MIT
---
