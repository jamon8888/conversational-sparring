---
name: senior-secops
description: Use when performing security scans, assessing codebase vulnerabilities, or ensuring regulatory compliance (SOC2, GDPR). Trigger when experiencing a security threat, needing to harden an application against attacks, or preparing for a security audit.
license: MIT
---
