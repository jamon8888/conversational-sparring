...
description: Use when choosing between different technologies, frameworks, or cloud providers for a new project. Trigger when experiencing "choice paralysis" between similar tools (e.g., React vs Vue), needing a Total Cost of Ownership (TCO) analysis, or evaluating the ecosystem health of a potential dependency.
license: MIT
---
